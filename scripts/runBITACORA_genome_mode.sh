...
export PATH=$PATH:./envs/hmm/bin
species=$PWD/*.fa
# PATH to BITACORA Scripts folder. 
SCRIPTDIR=./bitacora/Scripts
...
GEMOMAP=./GeMoMa-1.7.1/GeMoMa-1.7.1.jar

##########################################################
##                   PREPARE THE DATA                   ##
##########################################################

#file=/scratch/a200302/hox_gene/*.PRJ*/*.fa

# Include here the name of your species. i.e. NAME=Dmel
NAME=$(basename $species .fa)
